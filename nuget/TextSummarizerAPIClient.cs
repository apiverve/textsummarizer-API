...
namespace APIVerve.API.TextSummarizer
{
    ...
    /// <summary>
    /// Client for the TextSummarizer API
    /// </summary>
    public class TextSummarizerAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/textsummarizer";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "sentences", new ValidationRule { Type = "number", Required = false } }
        };
        ...
        public TextSummarizerAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TextSummarizerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TextSummarizerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TextSummarizerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TextSummarizerQueryOptions options)
        {
        ...
        public ResponseObj Execute(TextSummarizerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TextSummarizerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TextSummarizerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TextSummarizerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TextSummarizerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TextSummarizerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TextSummarizerQueryOptions options)
        {
