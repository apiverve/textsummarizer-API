// Package textsummarizer provides a Go client for the Text Summarizer API.
//
// For more information, visit: https://apiverve.com/marketplace/textsummarizer?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Text Summarizer API.
//
// Parameters:
//   - text (required): string - The text to summarize (up to 5000 characters)
//   - sentences: number - The length of the summary (number of sentences)
type Request struct {
	Text string `json:"text"` // Required
	Sentences int `json:"sentences,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"sentences": {Type: "number", Required: false},
	}
...
// ResponseData contains the data returned by the Text Summarizer API.
type ResponseData struct {
	OriginalWords int `json:"originalWords"`
	SummaryWords int `json:"summaryWords"`
