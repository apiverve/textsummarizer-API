...
class textsummarizerWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/textsummarizer');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"sentences":{"type":"number","required":false,"default":"3"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/textsummarizer`);
        }
    }
...
module.exports = textsummarizerWrapper;
